...
const InfoSection = () => {
  return (
    <div id="about" className="border-b border-gray-800 p-6 md:p-20">
      <motion.h1
        className="my-4 text-center text-2xl font-bold text-black md:mb-16 lg:text-5xl"
      ...
      <div className="mx-6 grid gap-4 p-4 md:container md:mx-auto md:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-100">Data Structure & Algorithms Topics</span>
          </div>
          <p className="mt-4 text-left text-xs text-gray-400 lg:text-sm">
            There is 9 data structure and algorithm topics. You can choose any
            topic you want to learn or improve yourself in from
            the list.
          </p>
        </motion.div>
        <motion.div
